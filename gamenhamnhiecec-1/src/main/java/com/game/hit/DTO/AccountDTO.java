...
public class AccountDTO {
    ...
    public AccountDTO(String username, String password, String role, String idFigure, int gold, int diamond, int rankPoint, String avartar, String friend, String history, String rank, String nameInGame) {
